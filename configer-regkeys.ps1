...
#Jens added: 
    ...
    Set-ItemProperty registry::HKEY_USERS\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize -Name "AppsUseLightTheme" -Value 0 -Type Dword -Force |
        Foreach {"{0} {1}" | Write-Output}

    Set-ItemProperty registry::HKEY_USERS\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize -Name "SystemUsesLightTheme" -Value 0 -Type Dword -Force |
        Foreach {"{0} {1}" | Write-Output}
    #####################################################################
